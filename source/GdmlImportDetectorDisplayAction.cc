...
GdmlImportDetectorDisplayAction::GdmlImportDetectorDisplayAction(const std::string &name)
  : PHG4DisplayAction(name)
  , m_MyVolume(nullptr)
{
}

GdmlImportDetectorDisplayAction::~GdmlImportDetectorDisplayAction()
{
...
void GdmlImportDetectorDisplayAction::ApplyDisplayAction(G4VPhysicalVolume *physvol)
{
